...
public class OffFile implements AutoCloseable {
    ...
    private final OffHeader header;

    private final long headerLines;
    private final long lineVertex0 = 0;
    private final long lineFace0 = 0;
    ...
    private OffHeader readHeader()  throws IOException, IllegalStateException {
        if (this.reader == null) {
        ...
        try {
            ...
            return new OffHeader(vertexCount, faceCount, edgeCount);
